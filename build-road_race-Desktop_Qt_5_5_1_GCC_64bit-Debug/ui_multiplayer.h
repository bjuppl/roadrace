...
public:
    ...
    void retranslateUi(QDialog *multiplayer)
    {
        ...
        fiveBtn->setText(QApplication::translate("multiplayer", "Five", 0));
        sevBtn->setText(QApplication::translate("multiplayer", "Seven", 0));
        randBtn->setText(QApplication::translate("multiplayer", "Random", 0));
